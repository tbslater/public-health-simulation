...
The R package `simmer` is used for simulation. The package is designed for DES model implementation and documentation can be found at [https://cran.r-project.org/web/packages/simmer/index.html](#0){.uri} \[8\].
